...
def detectUpperBody(image):
    cascadePath = "/C:/Users/shree/Virtual Dressing Room/Project/data/haarcascade_upperbody.xml"
...
def cvloop(run_event):
    ...
    while run_event.is_set(): 
        ...
        for face in faces: 
            ...
            if SPRITES[5]:
                findRects = []
                upperPath = "/C:/Users/shree/Virtual Dressing Room/Project/data/haarcascade_upperbody.xml"
                imageGray = cv2.cvtColor(image, cv2.COLOR_BGR2GRAY)
